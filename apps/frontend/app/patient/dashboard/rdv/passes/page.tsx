...
export default function RdvPassesPage() {
    ...
    const load = async () => {
      try {
        const res = await fetch(
          `http://localhost:3001/rdv/patient/${patientId}?type=passes`,
          { cache: "no-store" }
        );
  ...
  return (
    <div className="p-6 max-w-3xl mx-auto">
      ...
      <h1 className="text-2xl font-bold mb-6">Mes rendez-vous passés</h1>
